...
export default function Footer() {
  return (
    <>
      <footer className="relative bg-gray-300 dark:bg-gray-800 pt-20 pb-6">
        <div
        ...
        >
          ...
          >
            <polygon
              className="text-gray-300 dark:text-gray-800 fill-current"
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap text-center lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              <h4 className="text-3xl font-semibold dark:text-white">Contact me</h4>
              ...
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 ml-auto lg:text-right">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <a
                        className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-semibold block pb-2 text-sm"
                        href={Links.github}
                      >
                        Github
                      </a>
