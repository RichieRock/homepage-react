  ...
  return (
    <section className="relative py-20 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 mb-10">
        <h2 className="text-center w-full text-3xl font-semibold dark:text-white">
          Working experience
        </h2>
        <div className="divide-y divide-blue-100 dark:divide-gray-700 divide-opacity-60 space-y-10">
