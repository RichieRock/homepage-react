...
Lead architecture, fullstack development, and DevOps for a large renewable energy microservice platform. Define service boundaries, integration patterns, and reliability decisions in close collaboration with product and stakeholders. Use AI/LLM tooling daily to accelerate delivery and built Python AI algorithms to improve output quality.

#### Tech
Microservices, AWS, React, Spring Boot, TypeScript, Java, Python, PostgreSQL, MongoDB, CI/CD
...
Owned fullstack delivery and integration architecture for an enterprise sales platform. Improved performance, modernized frontend build stack (Webpack -> Vite), implemented Azure backend services, and delivered multi-system integrations (PLM/CRM/APIs/data pipelines) with strong DevOps practices.

#### Tech
React, TypeScript, Azure Functions, Node.js, SQL, MongoDB, Vite, REST APIs, Docker, CI/CD

## Earlier consulting highlights (2014-2021)

- Visma Consulting: Fullstack consultant and team lead in high-usage customer services, delivering integrations, architecture decisions, and end-to-end features in enterprise environments.
- Pipevisu: Built a serverless profile matching platform with React, GraphQL, and DynamoDB, focused on speed and data-access efficiency.
- Octo3 and ZEF: Delivered large frontend-heavy business platforms, modernization work, and long-term maintainable architecture choices.
- Early Vaisala and mobile work: Android and Java product development, including domain-specific applications and thesis-related engineering work.
